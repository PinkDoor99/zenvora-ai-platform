# Fixed Working Backend Server for Zenvora AI Platform
# Uses only built-in Windows PowerShell

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "    Fixed Working Backend Server" -ForegroundColor Cyan
...
function Start-Server {
    Write-Host "🚀 Starting Fixed Backend Server..." -ForegroundColor Green
            ...
            try {
                ...
                if ($Url -eq "/api/health") {
                    ...
                    $body = @{
                        ...
                        "version" = "1.0.0"
                        "backend" = "PowerShell Fixed Server"
                ...
                if ($Request.HttpMethod -eq "POST" -and $Url -eq "/api/tools/generate-code") {
                    ...
                    $template = @"
// Generated {0} code based on: {1}
function generatedFunction() {{
    // AI-generated implementation
    console.log("Generated code for: {1}");
...
"@
                    ...
                    $generatedCode = $template -f $Language, $Description
