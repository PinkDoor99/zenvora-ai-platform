...
try {
        ...
        try {
            ...
            if (Test-Path $filePath -PathType Leaf) {
                ...
                if (Test-Path $defaultPath) {
                    ...
                    $content = "<h1>Zenvora AI Platform</h1><p>File not found: $url</p>"
                    $response.ContentType = "text/html; charset=utf-8"
    ...
    Write-Host "   2. Use IIS_SERVER.bat" -ForegroundColor Gray
    Write-Host "   3. Use web_server.vbs" -ForegroundColor Gray
} finally {
